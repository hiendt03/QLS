...
namespace QLS
{
    public partial class form_CaiDat : Form
    {
        ...
        public void Change_Language_VI()
        {
            ...
            label_CheDoToiNoiDung.Text = "Điều chỉnh giao diện của QLS để giảm độ chói và cho đôi mắt được nghỉ ngơi.";
        ...
        public void Change_Language_EN()
        {
            ...
            label_NgonNguNoiDung.Text = "Adjust QLS’s language to suit you.";
            label_CheDoToi.Text = "Dark mode";
            label_CheDoToiNoiDung.Text = "Adjust QLS’s interface to reduce brightness and make your eyes feel better.";
            ...
            (this.Owner as form_Chinh).button_BaoCao.Text = "Bill";
                ...
                else if (textbox_MatKhauHienTai.Texts.Trim().Length > 0 || textbox_MatKhauMoi1.Texts.Trim().Length > 0 || textbox_MatKhauMoi2.Texts.Length > 0)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (!AccountDAO.Instance.DoiMatKhau(tk, textbox_MatKhauMoi1.Texts))
                                {
