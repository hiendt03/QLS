...
namespace QLS
{
    public partial class form_HoaDon : Form
    {
        ...
        public form_HoaDon(string tk)
        {
            ...
            CalculateTotalPages();
            dataGridView.DataSource = HoaDonDAO.Instance.GetCurrentRecords(CurrentPageIndex);
        }
        ...
        private void btnNxtPage_Click(object sender, EventArgs e)
        {
            ...
            if (textbox_TimKiem.Texts.Trim().Length > 0)
            {
              ...
              HoaDonDAO.Instance.GetCurrentRecordsByKeyword(this.CurrentPageIndexSearch, textbox_TimKiem.Texts);
                }
            ...
            else
            {
                if (this.CurrentPageIndex < this.TotalPage)
                {
                    ...
                    this.dataGridView.DataSource =
                HoaDonDAO.Instance.GetCurrentRecords(this.CurrentPageIndex);
                }
        ...
        private void CalculateTotalPagesSearch()
        {
            ...
            int rowCount = HoaDonDAO.Instance.CountResult(textbox_TimKiem.Texts);
        ...
        public int vt = -1;
        public void form_HoaDon_Load(object sender, EventArgs e)
        {
            if (!check_giaodien)
            {
        ...
        public void Change_Language_VI()
        {
            ...
            dataGridView.Columns[3].HeaderText = "Ngày lập";
        }
        ...
        private void button_TienLen2_Click(object sender, EventArgs e)
        {
            ...
            if (textbox_TimKiem.Texts.Trim().Length > 0)
            {
                if (this.CurrentPageIndexSearch < this.TotalPageSearch)
                {
                    ...
                    label_TrangHienTai.Text = CurrentPageIndexSearch.ToString();
                    this.dataGridView.DataSource =
              HoaDonDAO.Instance.GetCurrentRecordsByKeyword(this.TotalPageSearch, textbox_TimKiem.Texts);
                }
                if (CurrentPageIndexSearch == TotalPageSearch)
                {
                    button_TienLen2.BackColor = Color.DarkGray;
            ...
            else
            {
                if (this.CurrentPageIndex < this.TotalPage)
                {
                    ...
                    label_TrangHienTai.Text = CurrentPageIndex.ToString();
                    this.dataGridView.DataSource =
                HoaDonDAO.Instance.GetCurrentRecords(this.TotalPage);
                }
                if (CurrentPageIndex == TotalPage)
                {
                    button_TienLen2.BackColor = Color.DarkGray;
        ...
        public void Change_Language_EN()
        {
            ...
            dataGridView.Columns[0].HeaderText = "Bill ID";
            dataGridView.Columns[1].HeaderText = "Customer";
            dataGridView.Columns[3].HeaderText = "Total money";
            dataGridView.Columns[4].HeaderText = "Date created";
        }
        ...
        private void button_TimKiem_Click(object sender, EventArgs e)
        {
            if (textbox_TimKiem.Texts.Trim().Length > 0)
            {
                ...
                dataGridView.DataSource = HoaDonDAO.Instance.GetCurrentRecordsByKeyword(CurrentPageIndexSearch, textbox_TimKiem.Texts);
            }
            else
            {
                CalculateTotalPages();
        ...
        public void UpdateColorApp()
        {
            ...
            button_TienLen.BackColor = CaiDatDAO.Instance.color_BG_ColorApp_01;
            button_TienLen2.BackColor = CaiDatDAO.Instance.color_BG_ColorApp_01;
            button_TimKiem.BackColor = CaiDatDAO.Instance.color_BG_ColorApp_01;
        }
    }
}
