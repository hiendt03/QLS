...
namespace QLS
{
    class DateTimePicker_Custom : DateTimePicker
    {
        ...
        private Image calendarIcon = QLS.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = QLS.Properties.Resources.calendarDark;
                else calendarIcon = QLS.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
